<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="StockCheck.aspx.vb" Inherits="SchloetterSalesPortal.StockCheck" %>
    ...
    <div class="MainContent">
        <div class="FormHeader"> 
            <div class="twocolleft25" > 
                <div class="Table">
                    <div class="Row">
                        <div class="Cell"><asp:Label ID="Label1" runat="server" Text="Item Code" AssociatedControlID="ItemCode"></asp:Label></div>
                    ...
                    <div class="Row">
                        <div class="Cell"><asp:Label ID="Label2"  runat="server" Text="Item Name" AssociatedControlID="ItemCode"></asp:Label></div>
